...
interface IconProps {
  icon: 'mic' | 'speak' | 'moon' | 'sun' | 'text' | 'send' | 'close' | 'stop';
  className?: string;
}

export const Icon = ({ icon, className = 'w-6 h-6' }: IconProps) => {
  const icons: { [key: string]: React.ReactNode } = {
    mic: <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 0v-1.5a6 6 0 00-12 0v1.5m12 0v-1.5a6 6 0 00-12 0v1.5m6 6.375a3.375 3.375 0 01-3.375-3.375V1.5A3.375 3.375 0 0112 1.5a3.375 3.375 0 013.375 3.375v9.375a3.375 3.375 0 01-3.375 3.375z" />,
    ...
    stop: <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  };
